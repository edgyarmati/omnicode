...
- Use a split release setup model: `scripts/install.sh` is the public one-command installer, npm global install is the documented fallback, and `scripts/setup` prepares a local checkout and links `omnicode` for contributor/pre-release use.
